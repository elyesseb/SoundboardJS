...
exports.playbuttons = exports.default = playbuttons;
...
function playbuttons() {
  ...
  var btn9 = document.getElementById('btn__sound-9'); // mes sons :

  var sound1 = document.getElementById('sound-1');
  var sound2 = document.getElementById('sound-2');
  var sound3 = document.getElementById('sound-3');
  var sound4 = document.getElementById('sound-4');
  var sound5 = document.getElementById('sound-5');
  var sound6 = document.getElementById('sound-6');
  var sound7 = document.getElementById('sound-7');
  var sound8 = document.getElementById('sound-8');
  var sound9 = document.getElementById('sound-9'); // function jouer le son :
...
(0, _functions.playbuttons)();
},{"./functions.js":"src/js/functions.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
